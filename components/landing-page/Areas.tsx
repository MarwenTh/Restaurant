      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in order-2 lg:order-1">
            <div className="glass rounded-2xl overflow-hidden shadow-xl p-4 h-[450px] relative">
              ...
              <div className="absolute bottom-8 left-0 right-0 text-center">
                <p className="text-[#0a0c0e] font-medium">
          ...
          <div className="animate-slide-up order-1 lg:order-2">
            <div className="mb-8">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#64748b]" />
                <Input
                  type="text"
            ...
            <div className="glass rounded-2xl p-6 h-[350px] overflow-auto">
              <h3 className="text-xl font-bold mb-4">Available Cities</h3>
              ...
              {filteredCities.length > 0 ? (
                <div className="grid grid-cols-2 gap-4">
                  {filteredCities.map((city, index) => (
                    <div
                      key={city}
                      className="flex items-center p-3 rounded-lg hover:bg-[#f1f5f9]/50 transition-colors"
                    >
